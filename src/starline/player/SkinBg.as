package starline.player{
	...
	public class SkinBg extends Sprite {
		...
		public function SkinBg(_root:*):void {
			...
			square.graphics.drawRoundRect(3, 26, 801, 561, 11);
		...
		public function imgLoader(url:String):void {
			...
			request.url = Main.CS_SERVER_URL + Main.SKINS_FOLDER + url;
			loader.load(request);
		...
		public function eyeImgLoader(url:String):void {
			eye_Timer.reset();
			eye_request.url = Main.CS_SERVER_URL + Main.SKINS_FOLDER + url;
